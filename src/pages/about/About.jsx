    ...
    <>
      ...
      <div className="parent about-parent">
        <div className="cont about-cont">
          <p className='top-content'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
      ...
      <div className=" parent about-second">
        ...
        <div className="rigth">
          ...
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
            ...
            the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,
            and more recently with desktop publishing software like Aldus PageMaker
            including versions of Lorem Ipsum It has survived not only five centuries, but also the leap into
            electronic typesetting, remaining essentially unchanged. It was popularised in
            the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,
            and more recently with desktop publishing software like Aldus PageMaker
